...
def diabetes_linear_pipeline():
    ...
    # Here, Linear Regression usually shows similar train/test scores → low overfitting.
...
def cancer_logistic_regularization():
    ...
    # Very large C → weak regularization → model fits noise.
...
def cancer_cross_validation():
    ...
    # COMMENT:
    # In medical diagnosis, wrong predictions have serious consequences.
